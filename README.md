...
- **Automated tests:** 16 pytest tests covering CRUD, auth, validation and the FK-protection behaviour, run against an isolated SQLite database; CI runs them on every push via GitHub Actions
